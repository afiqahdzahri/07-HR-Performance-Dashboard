...
## Description
Short summary: HR Employee Performance Dashboard (Power BI). This repo is part of a multi-repo portfolio showcasing projects based on my Bachelor of Information Technology coursework.
...
git init
git add .
git commit -m "Initial commit - HR Employee Performance Dashboard (Power BI)"
gh repo create your-username/hr-performance-dashboard --public --source=. --remote=origin
